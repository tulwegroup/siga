                    ...
                    return (
                      <div key={method} className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm text-muted-foreground">
                            {count} items • {formatCurrency(methodValue)}
                          </span>
                        </div>
                        <Progress value={(count / (analytics.totalProcurements || 1)) * 100} className="h-2" />
                      </div>
                    );
                  })}
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 border rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium">Flagged Procurements</span>
                      </div>
                  ...
                  <div className="space-y-2">
                    <h4 className="font-medium">Common Compliance Issues</h4>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                        <span className="text-sm">Budget Exceedances</span>
                        <Badge variant="secondary">2 cases</Badge>
                      </div>
                      <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                        <span className="text-sm">Documentation Issues</span>
                        <Badge variant="secondary">1 case</Badge>
                      </div>
                      <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                        <span className="text-sm">Local Content Shortfalls</span>
                        <Badge variant="secondary">3 cases</Badge>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-3 border rounded-lg">
                    ...
                    <Progress value={(75 / 90) * 100} className="h-2 mb-2" />
                    <div className="text-xs text-muted-foreground">
                      <p className="font-medium mb-1">Recommendations:</p>
                      <ul className="list-disc list-inside space-y-1">
                        <li>Standardize tender documentation templates</li>
                  ...
                  <div className="p-3 border rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-medium text-sm">Local Content Monitoring</span>
                      <span className="text-xs text-muted-foreground">
                        58% → 70%
                      </span>
                    </div>
                    <Progress value={(58 / 70) * 100} className="h-2 mb-2" />
                    <div className="text-xs text-muted-foreground">
                      <p className="font-medium mb-1">Recommendations:</p>
                      <ul className="list-disc list-inside space-y-1">
                        <li>Enhance local supplier verification</li>
                        <li>Provide local capacity building support</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="p-3 border rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-medium text-sm">Budget Management</span>
                      <span className="text-xs text-muted-foreground">
                        82% → 95%
                      </span>
                    </div>
                    <Progress value={(82 / 95) * 100} className="h-2 mb-2" />
                    <div className="text-xs text-muted-foreground">
                      <p className="font-medium mb-1">Recommendations:</p>
                      <ul className="list-disc list-inside space-y-1">
                        <li>Strengthen cost estimation processes</li>
                        <li>Implement variance tracking systems</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="p-3 border rounded-lg">
                        ...
                        <div className="text-2xl font-bold text-green-600">
                          {aiAnalysis.compliance?.overallScore || 0}%
                        </div>
                      </div>
                      <div className="p-3 border rounded-lg">
                        <h5 className="font-medium mb-2">Risk Level</h5>
                        <Badge className={getRiskColor(aiAnalysis.risk?.overallRiskLevel || 'LOW')}>
                          {aiAnalysis.risk?.overallRiskLevel || 'LOW'}
                        </Badge>
                      </div>
                      <div className="p-3 border rounded-lg">
                        <h5 className="font-medium mb-2">Overall Health</h5>
                        <div className="text-lg font-bold text-blue-600">
                          {aiAnalysis.overallHealth?.grade || 'N/A'}
                        </div>
                        <div className="text-xs text-muted-foreground">
                    ...
                    {aiAnalysis.recommendations?.map((recommendation, idx) => (
                      <div key={idx} className="p-3 border rounded-lg">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <Badge variant={recommendation.priority === 'CRITICAL' ? 'destructive' : recommendation.priority === 'HIGH' ? 'default' : 'secondary'}>
                            {recommendation.priority}
                          </Badge>
                        </div>
                        <p className="text-sm text-muted-foreground mb-2">{recommendation.area}</p>
                        <p className="text-sm font-medium text-green-600 mb-1">Expected Impact:</p>
